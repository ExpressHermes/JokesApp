...
## Report bugs using Github's [issues](https://github.com/ExpressHermes/JokesApp/issues)
...
- Steps to reproduce
  - Be specific!
  - Give sample code if you can. [Sample stackoverflow question](http://stackoverflow.com/q/12488905/180626) includes sample code that *anyone* with a base R setup can run to reproduce what I was seeing
